...
-- Listar todas las empresas y cuántas facturas, notas débito y notas crédito se han generado entre dos fechas dadas
SELECT e.idempresa, e.razonsocial,
...
-- Listar por cada empresa, cuántos documentos tienen número o fecha por fuera del rango y vigencia permitido por la DIAN:
...
-- Teniendo en cuenta que las facturas suman y las notas débito suman, listar todas las empresas y el total de dinero recibido (base+impuestos). No incluir las notas crédito, ya que estas relacionan dinero que sale, no que entra:
SELECT e.idempresa, e.razonsocial, 
